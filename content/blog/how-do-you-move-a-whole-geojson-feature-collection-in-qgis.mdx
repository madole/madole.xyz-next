...
description: Move an entire GeoJSON feature collection to a new location using QGIS’s Vector tools Translate and Affine Transformation—no code required.
