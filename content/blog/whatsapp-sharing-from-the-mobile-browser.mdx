...
description: Open WhatsApp from the mobile browser and pre-fill a message using the whatsapp:// URL scheme.
tags: []
---
####BuzzFeed Says:
...
<p
  data-height="268"
  data-theme-id="0"
  data-slug-hash="rVzRxE"
  data-default-tab="result"
  data-user="madole"
  class="codepen"
>
  See the Pen <a href="https://codepen.io/madole/pen/rVzRxE/">Whatsapp Share</a>{" "}
  by Andrew McDowell (<a href="https://codepen.io/madole">@madole</a>) on{" "}
