...
description: GDAL's new unified CLI replaces a maze of inconsistent tools. A practical guide to the commands you actually need.
og_image: /og/gdal-evolved.jpg
tags:
  - geospatial
---
_(This was originally posted on the [Kablamo Engineering Blog](https://engineering.kablamo.com.au/posts/gdal-evolved/))_
