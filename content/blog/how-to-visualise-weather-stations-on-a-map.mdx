...
In Australia, we have a government organisation called the BOM (Beureau of Meteorology) which publishes a group of [CSV files of weather stations](http://www.bom.gov.au/climate/how/newproducts/images/ws_stations.zip).
