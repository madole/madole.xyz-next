  ...
  return (
    <>
      ...
      */}
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(ellipse_at_50%_0%,#111a3a_0%,#080b1c_45%,#05060f_100%)]" />
      ...
      */}
      <section className="relative flex min-h-dvh flex-col justify-between overflow-hidden">
        ...
        <div className="pointer-events-none relative z-20 flex flex-1 flex-col justify-between">
          ...
          >
            <h1
              className="mb-4 text-center text-4xl font-bold text-white sm:text-5xl md:text-left md:text-6xl"
